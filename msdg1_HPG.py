...
import warnings
# INPUT PARAMETERs
nconf =  2015 #20030 # number of configurations to take data for
...
def msdcalc():
    ...
    global natoms, typea,msdcall, num_counts, atom_id_mol_id_dict, match_list, middle_monomer_count, num_counts
...
def wholecalculation():
    ...
    global skip
    global natoms, typea,msdcall, atom_id_mol_id_dict, selected_mol_ids, match_list, num_counts, middle_monomer_count
